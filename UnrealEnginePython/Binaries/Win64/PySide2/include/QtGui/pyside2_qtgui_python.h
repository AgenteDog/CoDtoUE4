...
enum : int {
    ...
    SBK_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX                  = 57,
    ...
    SBK_QCOLORSPACE_IDX                                      = 38,
    SBK_QCOLORSPACE_NAMEDCOLORSPACE_IDX                      = 39,
    SBK_QCOLORSPACE_PRIMARIES_IDX                            = 40,
    SBK_QCOLORSPACE_TRANSFERFUNCTION_IDX                     = 41,
    SBK_QCONICALGRADIENT_IDX                                 = 42,
    SBK_QCONTEXTMENUEVENT_IDX                                = 43,
    SBK_QCONTEXTMENUEVENT_REASON_IDX                         = 44,
    SBK_QCURSOR_IDX                                          = 45,
    SBK_QDESKTOPSERVICES_IDX                                 = 46,
    SBK_QDOUBLEVALIDATOR_IDX                                 = 47,
    SBK_QDOUBLEVALIDATOR_NOTATION_IDX                        = 48,
    SBK_QDRAG_IDX                                            = 49,
    SBK_QDRAGENTEREVENT_IDX                                  = 50,
    SBK_QDRAGLEAVEEVENT_IDX                                  = 51,
    SBK_QDRAGMOVEEVENT_IDX                                   = 52,
    SBK_QDROPEVENT_IDX                                       = 53,
    SBK_QENTEREVENT_IDX                                      = 54,
    SBK_QEXPOSEEVENT_IDX                                     = 55,
    SBK_QFILEOPENEVENT_IDX                                   = 56,
    SBK_QFOCUSEVENT_IDX                                      = 79,
    SBK_QFONT_IDX                                            = 80,
    SBK_QFONT_STYLEHINT_IDX                                  = 85,
    SBK_QFONT_STYLESTRATEGY_IDX                              = 86,
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 376,
    SBK_QFONT_WEIGHT_IDX                                     = 87,
    SBK_QFONT_STYLE_IDX                                      = 84,
    SBK_QFONT_STRETCH_IDX                                    = 83,
    SBK_QFONT_CAPITALIZATION_IDX                             = 81,
    SBK_QFONT_SPACINGTYPE_IDX                                = 82,
    SBK_QFONTDATABASE_IDX                                    = 88,
    SBK_QFONTDATABASE_WRITINGSYSTEM_IDX                      = 90,
    SBK_QFONTDATABASE_SYSTEMFONT_IDX                         = 89,
    SBK_QFONTINFO_IDX                                        = 91,
    SBK_QFONTMETRICS_IDX                                     = 92,
    SBK_QFONTMETRICSF_IDX                                    = 93,
    SBK_QGRADIENT_IDX                                        = 94,
    SBK_QGRADIENT_TYPE_IDX                                   = 99,
    SBK_QGRADIENT_SPREAD_IDX                                 = 98,
    SBK_QGRADIENT_COORDINATEMODE_IDX                         = 95,
    SBK_QGRADIENT_INTERPOLATIONMODE_IDX                      = 96,
    SBK_QGRADIENT_PRESET_IDX                                 = 97,
    SBK_QGUIAPPLICATION_IDX                                  = 100,
    SBK_QHELPEVENT_IDX                                       = 101,
    SBK_QHIDEEVENT_IDX                                       = 102,
    SBK_QHOVEREVENT_IDX                                      = 103,
    SBK_QICON_IDX                                            = 104,
    SBK_QICON_MODE_IDX                                       = 105,
    SBK_QICON_STATE_IDX                                      = 106,
    SBK_QICONDRAGEVENT_IDX                                   = 107,
    SBK_QICONENGINE_IDX                                      = 108,
    SBK_QICONENGINE_ICONENGINEHOOK_IDX                       = 110,
    SBK_QICONENGINE_AVAILABLESIZESARGUMENT_IDX               = 109,
    SBK_QIMAGE_IDX                                           = 111,
    SBK_QIMAGE_INVERTMODE_IDX                                = 113,
    SBK_QIMAGE_FORMAT_IDX                                    = 112,
    SBK_QIMAGEIOHANDLER_IDX                                  = 114,
    SBK_QIMAGEIOHANDLER_IMAGEOPTION_IDX                      = 115,
    SBK_QIMAGEIOHANDLER_TRANSFORMATION_IDX                   = 116,
    SBK_QFLAGS_QIMAGEIOHANDLER_TRANSFORMATION_IDX            = 58,
    SBK_QIMAGEREADER_IDX                                     = 117,
    SBK_QIMAGEREADER_IMAGEREADERERROR_IDX                    = 118,
    SBK_QIMAGEWRITER_IDX                                     = 119,
    SBK_QIMAGEWRITER_IMAGEWRITERERROR_IDX                    = 120,
    SBK_QINPUTEVENT_IDX                                      = 121,
    SBK_QINPUTMETHOD_IDX                                     = 122,
    SBK_QINPUTMETHOD_ACTION_IDX                              = 123,
    SBK_QINPUTMETHODEVENT_IDX                                = 124,
    SBK_QINPUTMETHODEVENT_ATTRIBUTETYPE_IDX                  = 126,
    SBK_QINPUTMETHODEVENT_ATTRIBUTE_IDX                      = 125,
    SBK_QINPUTMETHODQUERYEVENT_IDX                           = 127,
    SBK_QINTVALIDATOR_IDX                                    = 128,
    SBK_QKEYEVENT_IDX                                        = 129,
    SBK_QKEYSEQUENCE_IDX                                     = 130,
    SBK_QKEYSEQUENCE_STANDARDKEY_IDX                         = 133,
    SBK_QKEYSEQUENCE_SEQUENCEFORMAT_IDX                      = 131,
    SBK_QKEYSEQUENCE_SEQUENCEMATCH_IDX                       = 132,
    SBK_QLINEARGRADIENT_IDX                                  = 134,
    SBK_QMATRIX_IDX                                          = 135,
    SBK_QMATRIX2X2_IDX                                       = 136,
    SBK_QGENERICMATRIX_2_2_FLOAT_IDX                         = 136,
    SBK_QMATRIX2X3_IDX                                       = 137,
    SBK_QGENERICMATRIX_2_3_FLOAT_IDX                         = 137,
    SBK_QMATRIX2X4_IDX                                       = 138,
    SBK_QGENERICMATRIX_2_4_FLOAT_IDX                         = 138,
    SBK_QMATRIX3X2_IDX                                       = 139,
    SBK_QGENERICMATRIX_3_2_FLOAT_IDX                         = 139,
    SBK_QMATRIX3X3_IDX                                       = 140,
    SBK_QGENERICMATRIX_3_3_FLOAT_IDX                         = 140,
    SBK_QMATRIX3X4_IDX                                       = 141,
    SBK_QGENERICMATRIX_3_4_FLOAT_IDX                         = 141,
    SBK_QMATRIX4X2_IDX                                       = 142,
    SBK_QGENERICMATRIX_4_2_FLOAT_IDX                         = 142,
    SBK_QMATRIX4X3_IDX                                       = 143,
    SBK_QGENERICMATRIX_4_3_FLOAT_IDX                         = 143,
    SBK_QMATRIX4X4_IDX                                       = 144,
    SBK_QMOUSEEVENT_IDX                                      = 145,
    SBK_QMOVEEVENT_IDX                                       = 146,
    SBK_QMOVIE_IDX                                           = 147,
    SBK_QMOVIE_MOVIESTATE_IDX                                = 149,
    SBK_QMOVIE_CACHEMODE_IDX                                 = 148,
    SBK_QNATIVEGESTUREEVENT_IDX                              = 150,
    SBK_QOFFSCREENSURFACE_IDX                                = 151,
    SBK_QOPENGLBUFFER_IDX                                    = 152,
    SBK_QOPENGLBUFFER_TYPE_IDX                               = 155,
    SBK_QOPENGLBUFFER_USAGEPATTERN_IDX                       = 156,
    SBK_QOPENGLBUFFER_ACCESS_IDX                             = 153,
    SBK_QOPENGLBUFFER_RANGEACCESSFLAG_IDX                    = 154,
    SBK_QFLAGS_QOPENGLBUFFER_RANGEACCESSFLAG_IDX             = 59,
    SBK_QOPENGLCONTEXT_IDX                                   = 157,
    SBK_QOPENGLCONTEXT_OPENGLMODULETYPE_IDX                  = 158,
    SBK_QOPENGLCONTEXTGROUP_IDX                              = 159,
    SBK_QOPENGLDEBUGLOGGER_IDX                               = 160,
    SBK_QOPENGLDEBUGLOGGER_LOGGINGMODE_IDX                   = 161,
    SBK_QOPENGLDEBUGMESSAGE_IDX                              = 162,
    SBK_QOPENGLDEBUGMESSAGE_SOURCE_IDX                       = 164,
    SBK_QFLAGS_QOPENGLDEBUGMESSAGE_SOURCE_IDX                = 61,
    SBK_QOPENGLDEBUGMESSAGE_TYPE_IDX                         = 165,
    SBK_QFLAGS_QOPENGLDEBUGMESSAGE_TYPE_IDX                  = 62,
    SBK_QOPENGLDEBUGMESSAGE_SEVERITY_IDX                     = 163,
    SBK_QFLAGS_QOPENGLDEBUGMESSAGE_SEVERITY_IDX              = 60,
    SBK_QOPENGLEXTRAFUNCTIONS_IDX                            = 166,
    SBK_QOPENGLFRAMEBUFFEROBJECT_IDX                         = 167,
    SBK_QOPENGLFRAMEBUFFEROBJECT_ATTACHMENT_IDX              = 168,
    SBK_QOPENGLFRAMEBUFFEROBJECT_FRAMEBUFFERRESTOREPOLICY_IDX = 169,
    SBK_QOPENGLFRAMEBUFFEROBJECTFORMAT_IDX                   = 170,
    SBK_QOPENGLFUNCTIONS_IDX                                 = 171,
    SBK_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX                   = 172,
    SBK_QFLAGS_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX            = 63,
    SBK_QOPENGLPIXELTRANSFEROPTIONS_IDX                      = 173,
    SBK_QOPENGLSHADER_IDX                                    = 174,
    SBK_QOPENGLSHADER_SHADERTYPEBIT_IDX                      = 175,
    SBK_QFLAGS_QOPENGLSHADER_SHADERTYPEBIT_IDX               = 64,
    SBK_QOPENGLSHADERPROGRAM_IDX                             = 176,
    SBK_QOPENGLTEXTURE_IDX                                   = 177,
    SBK_QOPENGLTEXTURE_TARGET_IDX                            = 191,
    SBK_QOPENGLTEXTURE_BINDINGTARGET_IDX                     = 178,
    SBK_QOPENGLTEXTURE_MIPMAPGENERATION_IDX                  = 186,
    SBK_QOPENGLTEXTURE_TEXTUREUNITRESET_IDX                  = 194,
    SBK_QOPENGLTEXTURE_TEXTUREFORMAT_IDX                     = 192,
    SBK_QOPENGLTEXTURE_TEXTUREFORMATCLASS_IDX                = 193,
    SBK_QOPENGLTEXTURE_CUBEMAPFACE_IDX                       = 182,
    SBK_QOPENGLTEXTURE_PIXELFORMAT_IDX                       = 187,
    SBK_QOPENGLTEXTURE_PIXELTYPE_IDX                         = 188,
    SBK_QOPENGLTEXTURE_SWIZZLECOMPONENT_IDX                  = 189,
    SBK_QOPENGLTEXTURE_SWIZZLEVALUE_IDX                      = 190,
    SBK_QOPENGLTEXTURE_WRAPMODE_IDX                          = 195,
    SBK_QOPENGLTEXTURE_COORDINATEDIRECTION_IDX               = 181,
    SBK_QOPENGLTEXTURE_FEATURE_IDX                           = 184,
    SBK_QFLAGS_QOPENGLTEXTURE_FEATURE_IDX                    = 65,
    SBK_QOPENGLTEXTURE_DEPTHSTENCILMODE_IDX                  = 183,
    SBK_QOPENGLTEXTURE_COMPARISONFUNCTION_IDX                = 179,
    SBK_QOPENGLTEXTURE_COMPARISONMODE_IDX                    = 180,
    SBK_QOPENGLTEXTURE_FILTER_IDX                            = 185,
    SBK_QOPENGLTEXTUREBLITTER_IDX                            = 196,
    SBK_QOPENGLTEXTUREBLITTER_ORIGIN_IDX                     = 197,
    SBK_QOPENGLTIMEMONITOR_IDX                               = 198,
    SBK_QOPENGLTIMERQUERY_IDX                                = 199,
    SBK_QOPENGLVERSIONPROFILE_IDX                            = 200,
    SBK_QOPENGLVERTEXARRAYOBJECT_IDX                         = 201,
    SBK_QOPENGLVERTEXARRAYOBJECT_BINDER_IDX                  = 202,
    SBK_QOPENGLWINDOW_IDX                                    = 203,
    SBK_QOPENGLWINDOW_UPDATEBEHAVIOR_IDX                     = 204,
    SBK_QPAGELAYOUT_IDX                                      = 205,
    SBK_QPAGELAYOUT_UNIT_IDX                                 = 208,
    SBK_QPAGELAYOUT_ORIENTATION_IDX                          = 207,
    SBK_QPAGELAYOUT_MODE_IDX                                 = 206,
    SBK_QPAGESIZE_IDX                                        = 209,
    SBK_QPAGESIZE_PAGESIZEID_IDX                             = 210,
    SBK_QPAGESIZE_UNIT_IDX                                   = 212,
    SBK_QPAGESIZE_SIZEMATCHPOLICY_IDX                        = 211,
    SBK_QPAGEDPAINTDEVICE_IDX                                = 213,
    SBK_QPAGEDPAINTDEVICE_PAGESIZE_IDX                       = 215,
    SBK_QPAGEDPAINTDEVICE_PDFVERSION_IDX                     = 216,
    SBK_QPAGEDPAINTDEVICE_MARGINS_IDX                        = 214,
    ...
    SBK_QFLAGS_QPAINTENGINE_PAINTENGINEFEATURE_IDX           = 67,
    SBK_QPAINTENGINE_DIRTYFLAG_IDX                           = 221,
    SBK_QFLAGS_QPAINTENGINE_DIRTYFLAG_IDX                    = 66,
    ...
    SBK_QFLAGS_QPAINTER_RENDERHINT_IDX                       = 69,
    SBK_QPAINTER_PIXMAPFRAGMENTHINT_IDX                      = 230,
    SBK_QFLAGS_QPAINTER_PIXMAPFRAGMENTHINT_IDX               = 68,
    ...
    SBK_QPEN_IDX                                             = 240,
    SBK_QPICTURE_IDX                                         = 241,
    SBK_QPICTUREIO_IDX                                       = 242,
    ...
    SBK_QPOINTINGDEVICEUNIQUEID_IDX                          = 254,
    SBK_QPOLYGON_IDX                                         = 255,
    SBK_QVECTOR_QPOINT_IDX                                   = 255,
    SBK_QPOLYGONF_IDX                                        = 256,
    SBK_QVECTOR_QPOINTF_IDX                                  = 256,
    SBK_QPYTEXTOBJECT_IDX                                    = 257,
    SBK_QQUATERNION_IDX                                      = 258,
    SBK_QRADIALGRADIENT_IDX                                  = 259,
    SBK_QRASTERWINDOW_IDX                                    = 260,
    SBK_QRAWFONT_IDX                                         = 261,
    SBK_QRAWFONT_ANTIALIASINGTYPE_IDX                        = 262,
    SBK_QRAWFONT_LAYOUTFLAG_IDX                              = 263,
    SBK_QFLAGS_QRAWFONT_LAYOUTFLAG_IDX                       = 70,
    SBK_QREGEXPVALIDATOR_IDX                                 = 264,
    SBK_QREGION_IDX                                          = 265,
    SBK_QREGION_REGIONTYPE_IDX                               = 266,
    SBK_QRESIZEEVENT_IDX                                     = 267,
    SBK_QSCREEN_IDX                                          = 268,
    SBK_QSCROLLEVENT_IDX                                     = 269,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 270,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 271,
    SBK_QSESSIONMANAGER_IDX                                  = 272,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 273,
    SBK_QSHORTCUTEVENT_IDX                                   = 274,
    SBK_QSHOWEVENT_IDX                                       = 275,
    SBK_QSTANDARDITEM_IDX                                    = 276,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 277,
    SBK_QSTANDARDITEMMODEL_IDX                               = 278,
    SBK_QSTATICTEXT_IDX                                      = 279,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 280,
    SBK_QSTATUSTIPEVENT_IDX                                  = 281,
    SBK_QSTYLEHINTS_IDX                                      = 282,
    SBK_QSURFACE_IDX                                         = 283,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 284,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 285,
    SBK_QSURFACEFORMAT_IDX                                   = 286,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 288,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 71,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 291,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 290,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 289,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 287,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 292,
    SBK_QTABLETEVENT_IDX                                     = 293,
    SBK_QTABLETEVENT_TABLETDEVICE_IDX                        = 295,
    SBK_QTABLETEVENT_POINTERTYPE_IDX                         = 294,
    SBK_QTEXTBLOCK_IDX                                       = 296,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 297,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 298,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 377,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 299,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 300,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 301,
    SBK_QTEXTCHARFORMAT_IDX                                  = 302,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 305,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 304,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 303,
    SBK_QTEXTCURSOR_IDX                                      = 306,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 307,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 308,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 309,
    SBK_QTEXTDOCUMENT_IDX                                    = 310,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 313,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 312,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 73,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 311,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 72,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 314,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 315,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 316,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 317,
    SBK_QTEXTFORMAT_IDX                                      = 318,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 319,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 322,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 320,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 321,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 74,
    SBK_QTEXTFRAGMENT_IDX                                    = 323,
    SBK_QTEXTFRAME_IDX                                       = 324,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 325,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 326,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 328,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 327,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 329,
    SBK_QTEXTINLINEOBJECT_IDX                                = 330,
    SBK_QTEXTITEM_IDX                                        = 331,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 332,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 75,
    SBK_QTEXTLAYOUT_IDX                                      = 333,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 334,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 335,
    SBK_QTEXTLENGTH_IDX                                      = 336,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 337,
    SBK_QTEXTLINE_IDX                                        = 338,
    SBK_QTEXTLINE_EDGE_IDX                                   = 340,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 339,
    SBK_QTEXTLIST_IDX                                        = 341,
    SBK_QTEXTLISTFORMAT_IDX                                  = 342,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 343,
    SBK_QTEXTOBJECT_IDX                                      = 344,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 345,
    SBK_QTEXTOPTION_IDX                                      = 346,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 349,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 350,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 347,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 76,
    SBK_QTEXTOPTION_TAB_IDX                                  = 348,
    SBK_QTEXTTABLE_IDX                                       = 351,
    SBK_QTEXTTABLECELL_IDX                                   = 352,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 353,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 354,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 355,
    SBK_QTOUCHDEVICE_IDX                                     = 356,
    SBK_QTOUCHDEVICE_DEVICETYPE_IDX                          = 358,
    SBK_QTOUCHDEVICE_CAPABILITYFLAG_IDX                      = 357,
    SBK_QFLAGS_QTOUCHDEVICE_CAPABILITYFLAG_IDX               = 77,
    SBK_QTOUCHEVENT_IDX                                      = 359,
    SBK_QTOUCHEVENT_TOUCHPOINT_IDX                           = 360,
    SBK_QTOUCHEVENT_TOUCHPOINT_INFOFLAG_IDX                  = 361,
    SBK_QFLAGS_QTOUCHEVENT_TOUCHPOINT_INFOFLAG_IDX           = 78,
    SBK_QTRANSFORM_IDX                                       = 362,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 363,
    SBK_QVALIDATOR_IDX                                       = 364,
    SBK_QVALIDATOR_STATE_IDX                                 = 365,
    SBK_QVECTOR2D_IDX                                        = 366,
    SBK_QVECTOR3D_IDX                                        = 367,
    SBK_QVECTOR4D_IDX                                        = 368,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 369,
    SBK_QWHEELEVENT_IDX                                      = 370,
    SBK_QWINDOW_IDX                                          = 371,
    SBK_QWINDOW_VISIBILITY_IDX                               = 373,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 372,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 374,
    SBK_QtGuiQT_IDX                                          = 375,
    SBK_QtGui_IDX_COUNT                                      = 378
};
