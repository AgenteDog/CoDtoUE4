...
enum : int {
    ...
    SBK_QT3DRENDER_QRENDERCAPABILITIES_IDX                   = 111,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_API_IDX               = 112,
    SBK_QT3DRENDER_QRENDERCAPABILITIES_PROFILE_IDX           = 113,
    SBK_QT3DRENDER_QRENDERCAPTURE_IDX                        = 114,
    SBK_QT3DRENDER_QRENDERCAPTUREREPLY_IDX                   = 115,
    SBK_QT3DRENDER_QRENDERPASS_IDX                           = 116,
    SBK_QT3DRENDER_QRENDERPASSFILTER_IDX                     = 117,
    SBK_QT3DRENDER_QRENDERSETTINGS_IDX                       = 118,
    SBK_QT3DRENDER_QRENDERSETTINGS_RENDERPOLICY_IDX          = 119,
    SBK_QT3DRENDER_QRENDERSTATE_IDX                          = 120,
    SBK_QT3DRENDER_QRENDERSTATESET_IDX                       = 121,
    SBK_QT3DRENDER_QRENDERSURFACESELECTOR_IDX                = 122,
    SBK_QT3DRENDER_QRENDERTARGET_IDX                         = 123,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_IDX                   = 124,
    SBK_QT3DRENDER_QRENDERTARGETOUTPUT_ATTACHMENTPOINT_IDX   = 125,
    SBK_QT3DRENDER_QRENDERTARGETSELECTOR_IDX                 = 126,
    SBK_QT3DRENDER_QSCENELOADER_IDX                          = 127,
    SBK_QT3DRENDER_QSCENELOADER_STATUS_IDX                   = 129,
    SBK_QT3DRENDER_QSCENELOADER_COMPONENTTYPE_IDX            = 128,
    SBK_QT3DRENDER_QSCISSORTEST_IDX                          = 130,
    SBK_QT3DRENDER_QSCREENRAYCASTER_IDX                      = 131,
    SBK_QT3DRENDER_QSEAMLESSCUBEMAP_IDX                      = 132,
    SBK_QT3DRENDER_QSETFENCE_IDX                             = 133,
    SBK_QT3DRENDER_QSETFENCE_HANDLETYPE_IDX                  = 134,
    SBK_QT3DRENDER_QSHADERDATA_IDX                           = 135,
    SBK_QT3DRENDER_QSHADERIMAGE_IDX                          = 136,
    SBK_QT3DRENDER_QSHADERIMAGE_ACCESS_IDX                   = 137,
    SBK_QT3DRENDER_QSHADERIMAGE_IMAGEFORMAT_IDX              = 138,
    SBK_QT3DRENDER_QSHADERPROGRAM_IDX                        = 139,
    SBK_QT3DRENDER_QSHADERPROGRAM_SHADERTYPE_IDX             = 140,
    SBK_QT3DRENDER_QSHADERPROGRAM_STATUS_IDX                 = 141,
    SBK_QT3DRENDER_QSHADERPROGRAMBUILDER_IDX                 = 142,
    SBK_QT3DRENDER_QSHAREDGLTEXTURE_IDX                      = 143,
    SBK_QT3DRENDER_QSORTPOLICY_IDX                           = 144,
    SBK_QT3DRENDER_QSORTPOLICY_SORTTYPE_IDX                  = 145,
    SBK_QT3DRENDER_QSPOTLIGHT_IDX                            = 146,
    SBK_QT3DRENDER_QSTENCILMASK_IDX                          = 147,
    SBK_QT3DRENDER_QSTENCILOPERATION_IDX                     = 148,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_IDX            = 149,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_FACEMODE_IDX   = 150,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_OPERATION_IDX  = 151,
    SBK_QT3DRENDER_QSTENCILTEST_IDX                          = 152,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_IDX                 = 153,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFACEMODE_IDX = 154,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFUNCTION_IDX = 155,
    SBK_QT3DRENDER_QTECHNIQUE_IDX                            = 156,
    SBK_QT3DRENDER_QTECHNIQUEFILTER_IDX                      = 157,
    SBK_QT3DRENDER_QTEXTURE1D_IDX                            = 158,
    SBK_QT3DRENDER_QTEXTURE1DARRAY_IDX                       = 159,
    SBK_QT3DRENDER_QTEXTURE2D_IDX                            = 160,
    SBK_QT3DRENDER_QTEXTURE2DARRAY_IDX                       = 161,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLE_IDX                 = 162,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLEARRAY_IDX            = 163,
    SBK_QT3DRENDER_QTEXTURE3D_IDX                            = 164,
    SBK_QT3DRENDER_QTEXTUREBUFFER_IDX                        = 165,
    SBK_QT3DRENDER_QTEXTURECUBEMAP_IDX                       = 166,
    SBK_QT3DRENDER_QTEXTURECUBEMAPARRAY_IDX                  = 167,
    SBK_QT3DRENDER_QTEXTUREDATA_IDX                          = 168,
    SBK_QT3DRENDER_QTEXTUREGENERATOR_IDX                     = 169,
    SBK_QT3DRENDER_QTEXTUREIMAGE_IDX                         = 170,
    SBK_QT3DRENDER_QTEXTUREIMAGE_STATUS_IDX                  = 171,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATA_IDX                     = 172,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX            = 173,
    SBK_QT3DRENDER_QTEXTURELOADER_IDX                        = 174,
    SBK_QT3DRENDER_QTEXTURERECTANGLE_IDX                     = 175,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_IDX                      = 176,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_WRAPMODE_IDX             = 177,
    SBK_QT3DRENDER_QVIEWPORT_IDX                             = 178,
    SBK_QT3DRENDER_QWAITFENCE_IDX                            = 179,
    SBK_QT3DRENDER_QWAITFENCE_HANDLETYPE_IDX                 = 180,
    SBK_Qt3DRender_IDX_COUNT                                 = 181
};
